...
class Resume extends Component {
  render() {
    ...
    <h5>Meteor JS</h5>
    <p>I enjoy using Meteor for it's ease of use and simplicity, i feel it is a perfect way to get a web app up and running quickly and efficiently for a client. before going into production!  </p>
    </div>
    <div class="columns feature-item">
